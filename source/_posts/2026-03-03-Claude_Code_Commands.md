...
在使用 Claude Code 的过程中，我发现很多开发者只是停留在"问个问题、得到答案"的浅层使用上。但实际上，Claude Code 的强大之处在于它的**可编程性**——你可以通过配置文件、命令系统、工具调用来定制属于自己的 AI 编程工作流。

今天想和大家深入聊聊 **Commands **，这是 Claude Code 中最容易被忽视，但能极大提升效率的核心功能。
